...
describe("E2E: 予約作成フロー", () => {
  it("creates a reservation and shows detail trigger", async () => {
    ...
    fireEvent.change(screen.getByLabelText("開始日時"), { target: { value: "2025-12-02T09:00" } });
    fireEvent.change(screen.getByLabelText("終了日時"), { target: { value: "2025-12-02T10:00" } });
    ...
    fireEvent.click(screen.getByText(baseReservation.title));
